    ...
    public partial class addGestWorkSpace : MetroSetForm
    {
            ...
            try
            {
                ...
                if (id > 0)
                {
                    if (textBox1.Text.Length > 0 && textBox2.Text.Length > 0 && txtCode.Text.Length > 0)
                    {
                        ...
                        DialogResult dialogResult = MessageBox.Show("هل أنت متأكد من الحذف", "حذف عميل", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
        ...
        private void btnadd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (n1 && n2)
                {
                    ...
                    string gphone = textBox2.Text;
                    Guest_workspace gest1 = context.Guest_workspace.Where(x => x.Name == gname).Where(x => x.Phone == gphone).FirstOrDefault();
                    if (gest1 == null)
                    {
                    ...
                    {
                        MessageBox.Show($"هذا العميل موجود بالفعل و كوده هو {gest1.ID}", "تنبيه !", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
            }
            catch
        ...
        private void btnsearch_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("لا يوجد عميل بهذا الاسم أو الكود", "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    dataGridView1.Rows.Clear();
                }
            }
        }
        ...
        private void addGestWorkSpace_FormClosed(object sender, FormClosedEventArgs e)
        {
            context.Dispose();
        }
    }
